...
(function() {
	...
	if(jQuery.cookie("body-layout")) {
		if(jQuery.cookie("body-layout") == 'boxed') {
			$b.addClass('boxed');			
			$b.css('background', 'url(http://janxcode.com/olen/images/bg/bg12.png) repeat fixed center center transparent');
	...
	jQuery('.patterns a').click(function() {
		...
		if(current == 'Boxed') {
			...
			if(jQuery(this).hasClass('fullimage')) {
				$b.css('background', 'url(http://janxcode.com/olen/images/bg-image/'+pattern+'.jpg) no-repeat center center fixed');
				$b.css('background-size', 'cover');
			} else {
				$b.css('background', 'url(http://janxcode.com/olen/images/bg/'+pattern+'.png) repeat center center fixed');
				$b.css('background-size', 'auto');
			}
		}else {
	...
	var color = jQuery(this).attr('id');
	  ...
	  if (color == "3ea7d7") {
      var skin_link="http://janxcode.com/olen/css/skins/blue.css";
	  ...
	  if (color == "1DA879") {
      var skin_link="http://janxcode.com/olen/css/skins/green.css";
	  jQuery('#skin').attr('href', skin_link);
      $b.css('background-color',color);
	  jQuery.cookie("css",skin_link, {expires: 365, path: '/'});
	  return false;      
	  ...
	  if (color == "d80000") {
      var skin_link="http://janxcode.com/olen/css/skins/red.css";
	  jQuery('#skin').attr('href', skin_link);
      $b.css('background-color',color);
	  jQuery.cookie("css",skin_link, {expires: 365, path: '/'});
	  return false;      
	  ...
	  if (color == "E5493A") {
      var skin_link="http://janxcode.com/olen/css/skins/orange.css";
	  jQuery('#skin').attr('href', skin_link);
      $b.css('background-color',color);
	  jQuery.cookie("css",skin_link, {expires: 365, path: '/'});
	  return false;      
	  ...
	  if (color == "E22467") {
      var skin_link="http://janxcode.com/olen/css/skins/pink.css";
	  jQuery('#skin').attr('href', skin_link);
      $b.css('background-color',color);
	  jQuery.cookie("css",skin_link, {expires: 365, path: '/'});
	  return false;    
	  ...
	  if (color == "f5a823") {
      var skin_link="http://janxcode.com/olen/css/skins/sun.css";
	  jQuery('#skin').attr('href', skin_link);
      $b.css('background-color',color);
	  jQuery.cookie("css",skin_link, {expires: 365, path: '/'});
	  return false;     
	  ...
	  if (color == "9dc032") {
      var skin_link="http://janxcode.com/olen/css/skins/greentea.css";
	  jQuery('#skin').attr('href', skin_link);
      $b.css('background-color',color);
	  jQuery.cookie("css",skin_link, {expires: 365, path: '/'});
	  return false;   
	  ...
	  if (color == "32b4c0") {
      var skin_link="http://janxcode.com/olen/css/skins/torquze.css";
	  jQuery('#skin').attr('href', skin_link);
      $b.css('background-color',color);
	  jQuery.cookie("css",skin_link, {expires: 365, path: '/'});
	  return false;    
